...
const renderTabBar = (props: any, DefaultTabBar: any) => (
  <DefaultTabBar {...props}>
    {(node: any) => {
      ...
      const className = `text-dark bg-white dark:bg-dark dark:text-white cursor-pointer rounded-lg w-[194px] px-2 py-3 text-base font-semibold border border-solid border-[#b3b6bf33] text-center ${isActive ? 'gradient-bg text-white' : ''
        }`;
